...
if (process.env["ENVIRONMENT"] && !['QA', 'DEV'].includes(process.env["ENVIRONMENT"])) {
  ...
  projects: [
    {
      ...
      use: {
        ...
        channel: `chrome`,
        baseURL: process.env["ENVIRONMENT"] === 'DEV' ? process.env["BASE_URL_DEV"] : process.env["BASE_URL_QA"],
        storageState: state,
